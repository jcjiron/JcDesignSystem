...
const Template: Story<HomeAmenititesProps> = ({ ...props }: HomeAmenititesProps) => (
  <HomeAmenitites images={images} buttonLabel="Show all Amenities" {...props} />
);
