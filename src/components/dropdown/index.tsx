        ...
        >
            {Array.isArray(children)
                ? children.map((el, index) =>
                      React.cloneElement(
                          el as ReactElement<DropDownItemProps>,
                          {
                              closeDropDown,
                              key: index,
                          }
                ...
                : React.cloneElement(
                      children as ReactElement<DropDownItemProps>,
                      {
                          ...children.props,
                          closeDropDown,
                      }
...
export const DropDownToggle = ({
    ...
    const { clickedOutside, handleClickInside, listeningRef } =
        useClickOutside()
    ...
    return (
        ...
        >
            <span className="content d-flex align-items-center">
                {children}
            </span>
