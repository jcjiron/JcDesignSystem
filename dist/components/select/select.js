...
var SelectContainer = (0, styled_components_1.default)(
        ...
        __assign(
            {
                ...
                disabled: disabled,
                onClick: function () {
                    return onClick({ value: value, name: name })
                },
            },
            { children: name }
        )
        ...
        __assign(
            {
                ...
                placeholder:
                    ((_a = props.selectedOption) === null || _a === void 0
                        ? void 0
                        : _a.name) || props.placeholder,
            ...
            {
                children: props.options.map(function (_a) {
                    var _b
                    var name = _a.name,
                        value = _a.value
                    return (0,
                    jsx_runtime_1.jsx)(OptionComponent, { value: value, onClick: onClickItem, isSelected: value === ((_b = props.selectedOption) === null || _b === void 0 ? void 0 : _b.value), name: name }, value)
                }),
            }
        )
    )
