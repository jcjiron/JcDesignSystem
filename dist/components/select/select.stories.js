...
var Template = function (_a) {
    ...
    var _b = react_1.default.useState(options[0]),
        value = _b[0],
        setValue = _b[1]
    return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, {
        children: [
            (0, jsx_runtime_1.jsxs)(
                ...
                __assign(
                    { style: { color: '#8B6FC9' } },
                    { children: ['Selected value: ', value ? value.name : ''] }
                )
            ),
            (0, jsx_runtime_1.jsx)(
                _1.Select,
...
var ControlledComponent = function (_a) {
    ...
    return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, {
        children: [
            ...
            (0, jsx_runtime_1.jsx)(
                'button',
                __assign({ onClick: onClose }, { children: 'Close Dropdown' })
            ),
            (0, jsx_runtime_1.jsxs)(
                'p',
                __assign(
            ...
            (0, jsx_runtime_1.jsxs)(
                ...
                __assign(
                    { style: { color: '#8B6FC9' } },
                    { children: ['The modal is ', isOpen ? 'open' : 'closed'] }
                )
            ),
            (0, jsx_runtime_1.jsx)(
                _1.Select,
