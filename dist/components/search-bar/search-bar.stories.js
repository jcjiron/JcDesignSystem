...
var StyledSelect = (0, styled_components_1.default)(select_1.Select)(
    templateObject_1 ||
...
var StyledDropDown = (0, styled_components_1.default)(
...
var CalendarDropdown = (0, styled_components_1.default)(StyledDropDown)(
...
var CalendarComponent = function (_a) {
    ...
    var handleSelectRange = function (_a) {
        ...
        setCalendarSelectionRange(
            __assign(__assign({}, selection), { startDate: checkoutDate })
        )
    }
    return (0, jsx_runtime_1.jsx)(calendar_1.Calendar, {
...
var Template = function () {
    var _a = react_1.default.useState(),
        selectedCity = _a[0],
        setSelectedCity = _a[1]
    var _b = react_1.default.useState(),
        selectedNeighborhood = _b[0],
        setSelectedNeighborhood = _b[1]
    var _c = react_1.default.useState(1),
        guests = _c[0],
        setGuests = _c[1]
    return (0, jsx_runtime_1.jsxs)(index_1.default, {
        children: [
            (0, jsx_runtime_1.jsx)(StyledSelect, {
                options: cities,
            ...
            (0, jsx_runtime_1.jsx)(
                CalendarDropdown,
                __assign(
                    { placeholder: 'Check In - Check Out', variant: 'light' },
                    {
                        children: (0, jsx_runtime_1.jsx)(CalendarComponent, {
                            columns: 2,
                            className: '',
                        }),
                    }
            ...
            (0, jsx_runtime_1.jsx)(
                ...
                __assign(
                    {
                        variant: 'light',
                        placeholder: ''.concat(guests, ' guests'),
                    },
                    {
...
var BottomBarContainer = styled_components_1.default.div(
    templateObject_5 ||
...
var Mobile = function () {
    var _a = react_1.default.useReducer(reducer, initialState),
        step = _a[0].step,
        dispatch = _a[1]
    var _b = react_1.default.useState(),
        selectedCity = _b[0],
        setSelectedCity = _b[1]
    var _c = react_1.default.useState({
            startDate: new Date(),
            endDate: new Date(),
            key: 'selection',
        }),
        calendarSelectionRange = _c[0],
        setCalendarSelectionRange = _c[1]
    var handleSelectRange = function (_a) {
        var selection = _a.selection
        setCalendarSelectionRange(__assign({}, selection))
    }
    var _d = react_1.default.useState(),
        selectedNeighborhood = _d[0],
        setSelectedNeighborhood = _d[1]
    var _e = react_1.default.useState(1),
        guests = _e[0],
        setGuests = _e[1]
    ...
    if (step === 'city') {
        return (0, jsx_runtime_1.jsx)(StyledSelect, {
            isOpen: true,
            fullScreen: true,
            options: cities,
    ...
    if (step === 'guests') {
        return (0, jsx_runtime_1.jsxs)(
            ...
            __assign(
                ...
                {
                    children: [
                        (0, jsx_runtime_1.jsx)(CounterContainer, {
                            children: (0, jsx_runtime_1.jsx)(
                                counter_1.Counter,
                                {
                                    onChange: setGuests,
                        ...
                        (0, jsx_runtime_1.jsx)(BottomBarContainer, {
                            children: (0, jsx_runtime_1.jsx)(
                                button_1.default,
                                __assign(
                                    {
