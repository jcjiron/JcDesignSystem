...
function TwoColumnsModal(_a) {
    var staticColumn = _a.staticColumn,
        scrollableColumn = _a.scrollableColumn,
        _b = _a.variant,
        variant = _b === void 0 ? 'light' : _b,
        modalProps = __rest(_a, ['staticColumn', 'scrollableColumn', 'variant'])
        ...
        __assign(
            ...
            { variant: variant },
            {
                children: (0, jsx_runtime_1.jsxs)(
                    two_columns_layout_1.TwoColumnsLayout,
                    __assign(
