...
exports.Primary.args = {
    children: [
        (0, jsx_runtime_1.jsx)(item_1.ListItem, {
            bulletIcon: (0, jsx_runtime_1.jsxs)(
                icon_1.Icon,
                __assign(
                    { variant: 'icon-Checked-Radio' },
                    {
                        children: [
            ...
            children:
                'Our properties are cleaned to the highest hygiene and health standards',
        }),
        (0, jsx_runtime_1.jsx)(item_1.ListItem, {
            bulletIcon: (0, jsx_runtime_1.jsxs)(
                icon_1.Icon,
        ...
        (0, jsx_runtime_1.jsx)(item_1.ListItem, {
            children: (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, {
                children: [
                    (0, jsx_runtime_1.jsx)('span', {
                        children:
                            'Stay longer, save more.We have everything you need to turn our departments in your dreamed home.',
                    }),
                    (0, jsx_runtime_1.jsx)('br', {}),
                    (0, jsx_runtime_1.jsx)(
                        'a',
                        __assign({ href: '#' }, { children: 'Read More' })
                    ),
                ],
            }),
        }),
