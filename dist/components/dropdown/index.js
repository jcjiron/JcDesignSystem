...
var StyledDiv = styled_components_1.default.div(
    templateObject_1 ||
...
var DropDownItem = function (_a) {
    var children = _a.children,
        ...
        props = __rest(_a, ['children', 'closeDropDown'])
    return react_1.default.cloneElement(
        children,
        __assign(
            {
                className:
                    'align-middle dropdown-item d-flex align-items-center',
                onClick: function () {
                    var _a
        ...
        __assign(
            {
                className: 'dropdown-menu '
                    .concat(open ? open : '', ' ')
                    .concat(alignment !== 'normal' ? 'dropdown-menu-right' : '')
                    .concat(className),
            },
            {
                children: Array.isArray(children)
                    ...
                    : react_1.default.cloneElement(
                          children,
                          __assign(__assign({}, children.props), {
                              closeDropDown: closeDropDown,
                          })
                      ),
            }
...
var DropDownToggle = function (_a) {
    ...
    var _c = (0, use_click_outside_1.useClickOutside)(),
        clickedOutside = _c.clickedOutside,
        handleClickInside = _c.handleClickInside,
        listeningRef = _c.listeningRef
    ;(0, react_1.useEffect)(
        function () {
            if (clickedOutside) {
                closeDropDown && closeDropDown()
...
var DropDown = function (_a) {
    var children = _a.children,
        ...
        onClick = _a.onClick,
        _b = _a.dropDownOpen,
        dropDownOpen = _b === void 0 ? false : _b,
        props = __rest(_a, ['children', 'className', 'onClick', 'dropDownOpen'])
    var _c = (0, react_1.useState)(dropDownOpen),
        open = _c[0],
        setOpen = _c[1]
