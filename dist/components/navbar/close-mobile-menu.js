...
var MobileMenuButton = function (_a) {
    var isMenuOpen = _a.isMenuOpen, clickHandler = _a.clickHandler, className = _a.className;
    ...
    return ((0, jsx_runtime_1.jsx)(StyledButton, __assign({ className: "".concat(className, " justify-content-end ").concat(isMenuOpen ? 'pr-4' : '') }, { children: (0, jsx_runtime_1.jsxs)("button", __assign({ className: "navbar-toggler ".concat(isMenuOpen ? 'open' : ''), onClick: clickHandler, type: "button", "data-toggle": "collapse", "data-target": "#navbarMenu", "aria-controls": "navbarMenu", "aria-expanded": "false", "aria-label": "Toggle navigation" }, { children: [(0, jsx_runtime_1.jsx)("span", { className: "bar-menu" }), (0, jsx_runtime_1.jsx)("span", { className: "bar-menu" }), (0, jsx_runtime_1.jsx)("span", { className: "bar-menu" }), (0, jsx_runtime_1.jsx)("span", { className: "bar-menu" })] })) })));
};
