...
var Template = function (_a) {
    ...
    return (0, jsx_runtime_1.jsxs)(main_features_1.MainFeatures, {
        children: [
            (0, jsx_runtime_1.jsxs)(
                main_feature_item_1.MainFeatureItem,
                __assign(
                    {
                    ...
                    },
                    {
                        children: [
                            (0, jsx_runtime_1.jsx)('span', {
                                children: 'Check-in: 3:00 - 7:00PM',
                            }),
                            (0, jsx_runtime_1.jsx)('br', {}),
                            (0, jsx_runtime_1.jsx)('span', {
                                children: 'Check-Out: 3:00 - 7:00PM',
                            }),
                        ],
                    }
                )
                ...
                __assign(
                    ...
                    },
                    {
                        children: [
                            (0, jsx_runtime_1.jsx)('span', {
                                children:
                                    'Check-in: 3:00 - 7:00PM Check-in: 3:00 - 7:00PM',
                            }),
                            (0, jsx_runtime_1.jsx)('br', {}),
                            (0, jsx_runtime_1.jsx)('span', {
                                children: 'Check-Out: 3:00 - 7:00PM',
                ...
                __assign(
                    {
                        ...
                        title: 'title',
                        actionButton: (0, jsx_runtime_1.jsx)(
                            index_2.default,
                            __assign(
                                { variant: 'inline-link', onClick: onClick },
                                { children: 'Read More' }
                            )
                        ),
