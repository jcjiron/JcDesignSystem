...
var Container = (0, styled_components_1.default)(index_1.SpacingContainer)(
    templateObject_2 ||
    ...
    index_1.SpacingStyles,
    scroll_bar_1.customScrollBar
)
var ExampleContainer = styled_components_1.default.div(
    templateObject_3 ||
...
var SpacingTable = function (_a) {
    ...
    var combinations = [
        ...
        [
            ''.concat(prefix, 'x'),
            ''.concat(className, '-left'),
            ''.concat(className, '-right'),
        ],
        [
            ''.concat(prefix, 'y'),
                ...
                children: (0, jsx_runtime_1.jsxs)('table', {
                    children: [
                        ...
                        (0, jsx_runtime_1.jsx)('tbody', {
                            children: combinations.map(function (
                                combination,
                                index
                            ) {
                                var prefix = combination[0],
                                    class1 = combination[1],
                                    class2 = combination[2]
                                return properties.map(function (
                                    property,
                                    index
                                ) {
        ...
        __assign(
            { as: args.as },
            {
                children: [
                    ...
                    (0, jsx_runtime_1.jsx)(SpacingTable, { type: 'margin' }),
                    (0, jsx_runtime_1.jsx)('h2', {
                        children: 'Add margin to a single side',
                    }),
                    ...
                    (0, jsx_runtime_1.jsx)('h2', {
                        children: 'Add horizontal margin',
                    }),
                    (0, jsx_runtime_1.jsxs)('p', {
                        children: [
                    ...
                    (0, jsx_runtime_1.jsx)('h2', {
                        children: 'Add margin to all sides',
                    }),
                    (0, jsx_runtime_1.jsxs)('p', {
                        children: [
                    ...
                    (0, jsx_runtime_1.jsx)(ExampleContainer, {
...
var Padding = function (args) {
    return (0, jsx_runtime_1.jsxs)(
        Container,
        __assign({}, args, {
            children: [
                (0, jsx_runtime_1.jsx)('h1', { children: 'Padding' }),
                (0, jsx_runtime_1.jsx)('p', {
                    children: "Utilities for controlling an element's padding.",
                }),
                (0, jsx_runtime_1.jsx)(SpacingTable, { type: 'padding' }),
                (0, jsx_runtime_1.jsx)('h2', {
                    children: 'Add padding to a single side',
                }),
                (0, jsx_runtime_1.jsxs)('p', {
                    children: [
                ...
                (0, jsx_runtime_1.jsxs)('p', {
                    children: [
                        'For example, ',
                        (0, jsx_runtime_1.jsx)('code', { children: 'pt-6' }),
                        ' would add ',
                        (0, jsx_runtime_1.jsx)('code', { children: '1.5rem' }),
                        ' of padding to the top of an element,',
                        (0, jsx_runtime_1.jsx)('code', { children: 'pr-4' }),
                        ' would add ',
                        (0, jsx_runtime_1.jsx)('code', { children: '1rem' }),
                        ' of padding to the right of an element, ',
                        (0, jsx_runtime_1.jsx)('code', { children: 'pb-8' }),
                        ' would add ',
                        (0, jsx_runtime_1.jsx)('code', { children: '2rem' }),
                        ' of padding to the bottom of an element, and ',
                        (0, jsx_runtime_1.jsx)('code', { children: 'pl-2' }),
                        ' would add',
                        ' ',
                        (0, jsx_runtime_1.jsx)('code', { children: '0.5rem' }),
                        ' of padding to the left of an element.',
                    ],
                }),
                (0, jsx_runtime_1.jsx)('h2', {
                    children: 'Add horizontal padding',
                }),
                (0, jsx_runtime_1.jsxs)('p', {
                    children: [
                ...
                (0, jsx_runtime_1.jsx)('h2', {
                    children: 'Add padding to all sides',
                }),
                (0, jsx_runtime_1.jsxs)('p', {
                    children: [
                ...
                (0, jsx_runtime_1.jsx)(
                    ...
                    __assign(
                        { className: args.className },
                        {
                            children: (0, jsx_runtime_1.jsx)(Box, {
                                children: text,
                            }),
                        }
                    )
