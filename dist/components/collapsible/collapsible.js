...
var Collapsible = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(collapsible_context_1.CollapsibleContext.Provider, __assign({ value: { isOpen: getState().isOpen, onToggle: getState().onToggle } }, { children: children })));
};
