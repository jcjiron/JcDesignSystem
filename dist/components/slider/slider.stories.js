...
var Template = function (_a) {
    var args = __rest(_a, []);
    return ((0, jsx_runtime_1.jsx)(Container, __assign({ className: "container" }, { children: (0, jsx_runtime_1.jsx)(_1.Slider, __assign({ itemClassName: "col-10 col-md-4 col-lg-3 p-0", scrollContainerClassName: "row no-wrap" }, { children: images.map(function (image) { return ((0, jsx_runtime_1.jsx)(_1.Slider.Item, __assign({ itemId: image }, { children: (0, jsx_runtime_1.jsx)(Image, { src: image, alt: "Gato 1" }) }), image)); }) })) })));
};
