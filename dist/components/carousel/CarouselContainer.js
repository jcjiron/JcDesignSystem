...
var StyledCarousel = styled_components_1.default.div(
    templateObject_1 ||
...
var Carousel = function (_a) {
    var _b = _a.interval,
        ...
        images = _a.images,
        withControls = _a.withControls,
        _c = _a.withSwipe,
        withSwipe = _c === void 0 ? false : _c,
        _d = _a.withIndicators,
        withIndicators = _d === void 0 ? false : _d,
        _e = _a.withDescription,
        withDescription = _e === void 0 ? false : _e,
        _f = _a.links,
        links = _f === void 0 ? [] : _f,
        className = _a.className,
        onChangeSlide = _a.onChangeSlide,
        _g = _a.background,
        background = _g === void 0 ? 'transparent' : _g,
        _h = _a.transitionEffect,
        trasitionEffect = _h === void 0 ? 'fade' : _h,
        props = __rest(_a, [
            'interval',
            'images',
            'withControls',
    ...
    var _j = react_1.default.useState(0),
        activeIndex = _j[0],
        setActiveIndex = _j[1]
    var _k = react_1.default.useState(0),
        touchStart = _k[0],
        setTouchStart = _k[1]
    var _l = react_1.default.useState(0),
        touchEnd = _l[0],
        setTouchEnd = _l[1]
    ...
    var advanceSlice = react_1.default.useCallback(
        function () {
    ...
    return (0, jsx_runtime_1.jsx)(
        StyledCarousel,
        __assign(
            { className: 'carousel-container '.concat(className) },
            props,
                    ...
                    __assign(
                        { className: 'images-container' },
                        {
                            children: [
                                ...
                                withDescription &&
                                    (0, jsx_runtime_1.jsx)(
                                        CarouselDescription_1.CarouselDescription,
                                        {
                                            images: images,
