...
var Template = function (_a) {
    var args = __rest(_a, [])
    var _b = react_1.default.useState('Tab-1'),
        activeTab = _b[0],
        setActiveTab = _b[1]
