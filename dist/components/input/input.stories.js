...
var StyledIcon = (0, styled_components_1.default)(icon_1.Icon)(
    templateObject_2 ||
...
var WithIcons = function (args) {
    return (0, jsx_runtime_1.jsx)(Container, {
        children: (0, jsx_runtime_1.jsx)(
            ...
            __assign({}, args, {
                as: 'button',
                icon: (0, jsx_runtime_1.jsx)(StyledIcon, {
                    variant: 'icon-Calendar',
                }),
                onClick: function () {
                    alert('hola')
                },
...
var ErrorMessage = styled_components_1.default.span(
    templateObject_3 ||
    ...
    return (0, jsx_runtime_1.jsx)(Container, {
        children: (0, jsx_runtime_1.jsx)(
            ...
            __assign({}, args, {
                ...
                errorMessage: (0, jsx_runtime_1.jsxs)(ErrorMessage, {
                    children: [
                        (0, jsx_runtime_1.jsx)(
                            'span',
                            __assign(
                        ...
                        (0, jsx_runtime_1.jsx)('span', {
                            children:
                                'Dates no longer available, select again.',
                        }),
                    ],
                }),
                onClick: function () {
            ...
            __assign(
                ...
                },
                {
                    children: [
                        ...
                        (0, jsx_runtime_1.jsx)('div', { className: 'flex-1' }),
                        (0, jsx_runtime_1.jsx)(counter_1.Counter, {
                            max: 10,
                            min: 1,
                            value: count,
                            onChange: setCount,
