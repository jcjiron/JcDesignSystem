...
var Default = function (args) {
    ...
    return ((0, jsx_runtime_1.jsx)(Container, { children: (0, jsx_runtime_1.jsx)(_1.GuestsInput, __assign({}, args, { as: "div", value: count, onChange: function (value) { return setCount(value); } })) }));
};
