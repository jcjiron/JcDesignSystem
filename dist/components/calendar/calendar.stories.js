...
var Base = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(index_1.Calendar, __assign({ ranges: [calendarSelectionRange], onChange: handleSelectRange, columns: 1, minDate: new Date(), maxDate: (0, addDays_1.default)(new Date(), 180) }, args)));
};
