...
export declare const Calendar: ({ resetRange, variant, columns, className, resetDateLabel, showResetDateButton, noticeLabel, ..._calendarProps }: CalendarProps) => JSX.Element;
