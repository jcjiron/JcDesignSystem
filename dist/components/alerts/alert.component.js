...
var StatefulAlert = function (_a) {
    var children = _a.children,
        ...
        isDismissed = _a.isDismissed,
        _b = _a.isDismissable,
        isDismissable = _b === void 0 ? false : _b,
        _c = _a.className,
        className = _c === void 0 ? '' : _c,
        _d = _a.backgroundColor,
        backgroundColor = _d === void 0 ? '' : _d,
        props = __rest(_a, [
            'children',
            'variant',
            'handleDismiss',
        ...
        __assign(
            {
                className: 'border-0 alert '
                    ...
                    .concat(variant, ' ')
                    .concat(isDismissed ? 'dismissed' : '', '  ')
                    .concat(className, ' shadow-sm'),
            ...
            props,
            {
                children: [
                    children,
                    isDismissable &&
                        (0, jsx_runtime_1.jsx)(close_button_1.CloseButton, {
                            onClick: handleDismiss,
                            style: {
                                color: (0, get_contrast_YIQ_1.getContrastYIQ)(
                                    backgroundColor
                                ),
                            },
                        }),
